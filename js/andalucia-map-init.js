/**
 * Andaluci 2019 - Open Source Map
 *
 * Author : Hector Ugalde
 *
 */
...
$(function () {
    ...
    var onClick = true;         //enable/disable onclick open link
    var newWindow = true;       //enable/disable open a page in a new window for onClick functionality
   ...
   //---------------------------
    ...
    function responsiveResize(){
        ...
        if (winWidth >= 960) {
            ...
            mapWidth = mapInitWidth * scale;
            mapHeight = mapInitHeight * scale;
